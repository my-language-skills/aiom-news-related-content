...
This plugin enhance [Simple metadata](https://github.com/my-language-skills/simple-metadata) with news related metadata.

== Description ==

This plugin provides the ability to have one metabox with news schema properties.
